...
module.exports = window.mock_db = [
	{
		...
		ingredients: [
			{ingredient: "onion", quantity: 1, measurement: null, modifier: "chopped"},
			{ingredient: "oil", quantity: 1, measurement: "tablespoon", modifier: null},
			{ingredient: "brown rice", quantity: 2.5, measurement: "cups", modifier: "cooked"},
			{ingredient: "cottage cheese", quantity: 1.5, measurement: "cups", modifier: null},
			{ingredient: "egg", quantity: 1, measurement: null, modifier: "beaten"},
			{ingredient: "parsley", quantity: .5, measurement: "cup", modifier: "chopped"},
			{ingredient: "raisins", quantity: .75, measurement: "cup", modifier: null},
			{ingredient: "dill", quantity: 1, measurement: "teaspoon", modifier: null},
	...
	},
	{
		...
		ingredients: [
			{ingredient: "onion", quantity: 1, measurement: null, modifier: "chopped fine"},
			{ingredient: "green pepper", quantity: 1, measurement: null, modifier: "chopped fine"},
			{ingredient: "garlic clove", quantity: 1, measurement: null, modifier: null},
			{ingredient: "olive oil", quantity: 1, measurement: "tablespoon", modifier: null},
			{ingredient: "tomato", quantity: 3, measurement: "cups", modifier: "chopped"},
			{ingredient: "parsley", quantity: .25, measurement: "cup", modifier: "chopped"},
			{ingredient: "basil", quantity: 1, measurement: "teaspoon", modifier: "dried"},
			{ingredient: "eggplant", quantity: 1.5, measurement: "pounds", modifier: null},
			{ingredient: "mozzarella cheese", quantity: .75, measurement: "cup", modifier: "grated"}
		],
